...
A printed feature about one person, read by scrolling. Six chapters on their own paper grounds: a title page, the arc (metal, the leap, the startup), the AI era, the proof, beyond work, and a colophon.
...
- **Proof** (the peak): an iris opens on Rolfe Legends 2, playable in the page on request, then the other builds as spreads.
- **Beyond work**: the one scrubbed clip, real juggling footage, in a captioned column.
- **Colophon**: small type, the email line, the print-CV line, the balls settle and hold.
